...
# with command line options: NANO -s NANO --data --conditions 106X_dataRun2_v37 --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmsxrootd.fnal.gov///store/data/Run2016B/DoubleMuon/MINIAOD/ver2_HIPM_UL2016_MiniAODv2-v1/120000/01D8A63E-7F1B-D34E-AE56-4A10898A7BFC.root'),
