...
# with command line options: NANO -s NANO --mc --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --conditions 106X_mcRun2_asymptotic_preVFP_v11 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT= cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --no_exec
